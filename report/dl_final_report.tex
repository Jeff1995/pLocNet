...
\title{
	...
	\vspace{1em}
	\large{题目\ \underline{\makebox[20em]{基于图卷积神经网络的蛋白亚细胞定位预测}}}
}

\author{姓名\ \underline{\makebox[12em]{曹智杰，李响，郭宇航}}\\
	学号\ \underline{\makebox[12em]{1701110560，1701111447，1701110049}}\\
	学院\ \underline{\makebox[12em]{生命科学学院，前沿交叉学科研究院，数学科学学院}}\\
	专业\ \underline{\makebox[12em]{生物信息学，整合生命科学，统计学}}
}

\date{2018 年 8 月 28 日}
